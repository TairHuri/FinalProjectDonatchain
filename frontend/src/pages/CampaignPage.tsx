...
const CampaignPage: React.FC = () => {
  ...
  return (
    <div className="campaign-container" dir="rtl">
      ...
      {/* Modals */}
      <Modal show={showCryptoPay} onClose={() => {} } component={<CryptoPayment close={() => setShowCryptoPay(false)} campaignId={campaign._id!} campaignTx={campaign.blockchainTx!} />} />
      <Modal show={showCreditPay} onClose={() => {} } component={<CreditPayment close={() => setShowCreditPay(false)} campaignId={campaign._id!}  />} />
